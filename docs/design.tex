...
Для обеспечения целостности базы данных вводятся различные ограничения на хранимые данные.
...
Спроектированная в соответствии с формализацией пользователей сервиса ролевая модель представлена в таблицах~\ref{tbl:guest-policy}-\ref{tbl:admin-policy}.
