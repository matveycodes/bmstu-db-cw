...
import { PurchasedSubscriptionMongoRepo } from "../purchased-subscription-repo";
import { SubscriptionMongoRepo } from "../subscription-repo";
import { UserMongoRepo } from "../user-repo";

let mongoConnection: MongoConnection;

let purchasedSubscriptionRepo: PurchasedSubscriptionRepo,
...
beforeAll(async () => {
  ...
  purchasedSubscriptionRepo = new PurchasedSubscriptionMongoRepo(
    mongoConnection
  );
...
afterEach(async () => {
  await mongoConnection.collection("purchasedSubscriptions").deleteMany();
